...
var walkthroughMutations = []struct {
	...
	{path: "cluster.features.update", args: []string{"--release-version", "4.4", "--dry-run"}},
...
var walkthroughHeaders = map[string]string{
	...
	"cluster.features.update":                     "FEATURE\tFROM\tTO\tERROR\tMESSAGE",
...
var walkthroughKeys = map[string]string{
	...
	"cluster.features.update":                     ".: _command _version dry_run results; results[]: error feature from message to",
