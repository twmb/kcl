...
func TestMetadata(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{name: "all", args: nil, keys: []string{"brokers", "cluster_id", "controller_id", "topics"}, awk: 5, rows: 2},
		{name: "cluster", args: []string{"--section", "cluster"}, keys: []string{"cluster_id", "controller_id"}, awk: 2, rows: 1},
		...
		{name: "named", args: []string{"m-b"}, keys: []string{"brokers", "cluster_id", "controller_id", "topics"}, awk: 5, rows: 1},
		{name: "missing topic", args: []string{"m-a", "nosuch"}, keys: []string{"brokers", "cluster_id", "controller_id", "topics"}, awk: 5, rows: 2, code: 1},
