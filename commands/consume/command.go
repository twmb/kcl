...
func (c *consumption) command() *cobra.Command {
	...
	cmd.Flags().StringVar(&c.protoFile, "proto-file", "", "an optional proto definition file to decode protobuf messages, requires --proto-message")
	cmd.Flags().StringVar(&c.protoMessage, "proto-message", "", "the proto.message structure in --proto-file to use for decoding, should in 'PackageName.MessageName' format, requires --proto-file")
